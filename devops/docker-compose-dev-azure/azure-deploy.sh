...
resourcename="corgicaredatabase"  # lower case, only
resourcegroup="corgicaredatabase_rg"
...
# git clone https://github.com/apilogicserver/corgicaredatabase.git
# cd corgicaredatabase
...
az group create --name corgicaredatabase_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group corgicaredatabase_rg --sku S1 --is-linux
az container create --resource-group corgicaredatabase_rg --name corgicaredatabase --image apilogicserver/corgicaredatabase:latest --dns-name-label corgicaredatabase --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//corgicaredatabase.westus.azurecontainer.io:5656'
